from customtkinter import CTkFrame, CTkLabel, CTkButton, CTkEntry, CTkSwitch, BooleanVar
...
class SignUpView(CTkFrame):
    def __init__(self, *args, **kwargs):
        ...
        self.header = CTkLabel(self, text="Create an account")
